          ...
          {categories.map((category) => (
            <Card key={category.id}>
              ...
              <CardFooter className="flex justify-between">
                <Button variant="outline" size="sm" onClick={() => router.push(`/dashboard/event-categories/${category.id}`)}>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        ...
                        {categoryToDelete?._count?.events > 0 && (
                          <p className="text-red-500 mt-2">
                            This category has {categoryToDelete._count.events} events. 
                    ...
                    <AlertDialogFooter>
                      ...
                      <AlertDialogAction 
                        ...
                        disabled={categoryToDelete?._count?.events > 0}
                      >
                        Delete
                      </AlertDialogAction>
                    </AlertDialogFooter>
