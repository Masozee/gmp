    ...
    return (
      <main className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 max-w-7xl">
            <h1 className="text-4xl md:text-5xl font-heading font-bold text-center" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 800 }}>Events & Activities</h1>
          </div>
        </header>
      ...
      <div className="container mx-auto px-4 max-w-7xl py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <aside className="lg:w-1/4 bg-white p-6 rounded-lg shadow-md h-fit sticky top-28">
            <h2 className="text-xl font-bold mb-4 text-gray-800" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 800 }}>Filter Events</h2>
          ...
          <div className="lg:w-3/4">
            <div className="mb-6">
              <p className="text-gray-600">
                Showing {filteredEvents.length} events {filter !== 'all' ? `in category "${filter.charAt(0).toUpperCase() + filter.slice(1)}"` : ''}
            ...
            {filteredEvents.length === 0 ? (
              <div className="bg-white p-12 rounded-lg shadow-md text-center">
                ...
                <h3 className="text-xl font-bold mb-2 text-gray-800" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 800 }}>No Events Found</h3>
                <p className="text-gray-600">Try using different filters or keywords.</p>
              </div>
            ) : (
                    ...
                    <div className="sm:w-1/3 relative">
                      ...
                      <div className="absolute top-2 left-2 flex gap-2">
                        <span className="text-xs font-semibold rounded-full px-2 py-0.5 bg-[#ffe066] text-black">
                          {event.isPaid ? `Rp${event.price?.toLocaleString('id-ID')}` : 'Free'}
                        </span>
                    ...
                    <div className="p-6 sm:w-2/3 flex flex-col">
                      ...
                      <div className="mb-4">
                        ...
                        <p className="text-sm text-gray-600">
                          {event.description.includes("Speakers:") ? 
                            event.description.split("Speakers:")[1].split(".")[0].trim() : 
                            "Speaker info will be announced"}
                        </p>
                      </div>
