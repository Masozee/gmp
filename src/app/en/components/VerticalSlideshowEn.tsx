...
const VerticalSlideshowEn = ({ slides: propSlides }: VerticalSlideshowProps) => {
          ...
          setSlides([
            { 
              ...
              content: {
                ...
                subtitle: 'Survey Report on Youth Civic Engagement',
                description: 'Explore survey data on Indonesian youth civic engagement. Hover over the map to see statistics by region.',
                buttonText: 'View Full Report',
                buttonLink: '/en/civic-space'
              }
            },
            {
              id: 2,
              ...
              content: {
                ...
                title: 'Building a Generation of Change Makers',
                subtitle: 'Youth Participation Foundation',
                description: 'Empowering Indonesian youth to actively participate in democracy and public policy formulation through engaging and relevant political education.',
                buttonText: 'Learn More',
                buttonLink: '/en/about-us/goals'
              }
            }
          ]);
        } finally {
          ...
          <div className={`flex space-y-3 ${isMobile ? 'flex-row space-x-3 space-y-0' : 'flex-col'}`}>
            {slides.map((_, index) => (
              <button
                ...
                className={`${isMobile ? 'w-4 h-4' : 'w-3 h-3'} rounded-full transition-all duration-300 ${
                  index === currentSlide 
...
export default VerticalSlideshowEn;