...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Add a new call-to-action section before the footer */}
      <section className="py-16 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-6 max-w-7xl text-center">
          <FadeIn direction="up" duration={800}>
            <h2 className="font-['PT_Serif'] text-3xl md:text-4xl font-bold mb-4 text-gray-900 dark:text-white">
              Ready to Get Involved?
            </h2>
            <p className="font-['Sora'] text-lg text-gray-700 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
              Join our community of politically engaged youth and make a difference today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button variant="default" size="lg" asChild>
                <Link href="/(admin)/admin/auth/login">
                  Admin Dashboard
                </Link>
              </Button>
            </div>
