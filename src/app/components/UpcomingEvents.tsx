    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="text-center mt-10">
          <Link href="/acara" 
            className="inline-block bg-transparent hover:bg-[#F06292] text-primary hover:text-white border border-primary hover:border-[#F06292] rounded-md px-6 py-3 font-medium transition-colors">
            Lihat Semua Acara
          </Link>
        </div>
      </div>
