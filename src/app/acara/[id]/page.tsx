      ...
      <main className="min-h-screen bg-gray-50">
        ...
        <div className="bg-primary py-32 text-white">
          <div className="container mx-auto px-4 max-w-7xl text-center">
            <div className="h-6 bg-blue-400 rounded w-1/3 mx-auto mb-4 animate-pulse"></div>
            <div className="h-10 bg-blue-300 rounded w-1/2 mx-auto animate-pulse"></div>
          </div>
        </div>
    ...
    return (
      <main className="min-h-screen bg-gray-50">
        <header className="bg-primary py-32 text-white shadow-lg">
          <div className="container mx-auto px-4 max-w-7xl text-center">
            <nav className="mb-4 text-sm text-blue-200 justify-center flex space-x-2">
      ...
      <header className="bg-primary py-32 text-white shadow-lg">
        <div className="container mx-auto px-4 max-w-7xl text-center">
          <nav className="mb-4 text-sm text-blue-200 justify-center flex space-x-2">
            ...
            <Link href="/acara" className="hover:underline">Acara</Link>
            <span className="text-blue-300">/</span>
            <span className="text-blue-100 truncate max-w-[200px] md:max-w-md">{event.title}</span>
        </nav>
          <h1 className="text-4xl md:text-5xl font-bold mt-1 truncate max-w-3xl mx-auto">{event.title}</h1>
        </div>
      </header>
      ...
      <div className="container mx-auto px-4 max-w-7xl py-8">
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden mb-8">
          ...
          <div className="relative h-72 md:h-96">
            ...
            {/* Title and meta moved to blue header above */}
          </div>
          ...
          <div className="p-6 md:p-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="md:col-span-2">
                ...
                <div className="mb-6">
                  <h3 className="text-lg font-semibold mb-2 text-gray-800">Deskripsi</h3>
                  <div className="prose prose-lg max-w-none text-gray-700" dangerouslySetInnerHTML={{ __html: event.description.replace(/\n/g, '<br />') }}></div>
                </div>
              ...
              <div className="lg:sticky lg:top-8 h-fit">
                ...
                <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                  ...
                  <div className="flex space-x-3 justify-center">
                    {[ 
                      {name: 'Facebook', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" /></svg>, color: 'bg-blue-600 hover:bg-blue-700'},
                      {name: 'Twitter', icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z" /></svg>, color: 'bg-blue-400 hover:bg-blue-500'},
