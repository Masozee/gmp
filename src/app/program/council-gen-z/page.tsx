            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-gray-800 mb-1">Kota Berkelanjutan</h4>
                    <p className="text-gray-700 text-sm">Masyarakat, NGO, perusahaan, dan pemerintah memiliki peran yang sama pentingnya dalam membangun kota yang ramah lingkungan tanpa merusak ekosistem yang ada khususnya dalam pembangunan IKN.</p>
                  </div>
                  
                  <div>
                    <h4 className="font-semibold text-gray-800 mb-1">Transportasi Berkelanjutan</h4>
                    <p className="text-gray-700 text-sm">Indonesia harus mencontoh Singapura yang berhasil menurunkan hampir setengah emisinya dengan membuat atap di atas trotoar demi kenyamanan pejalan kaki.</p>
                  </div>
                  
                  <div>
                    <h4 className="font-semibold text-gray-800 mb-1">Pariwisata, Limbah & Polusi Laut</h4>
                    <p className="text-gray-700 text-sm">Menghidupkan pemahaman tambahan bahwa sampah tidak cukup hanya dibuang melainkan harus dipilah dengan benar sebagai bentuk mitigasi penumpukan sampah dengan kandungan gas metana yang tinggi.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-gray-800 mb-1">Kota Berkelanjutan</h4>
                    <p className="text-gray-700 text-sm">Sebelum mengeluarkan Izin Usaha Pertambangan (IUP), diperlukan proses verifikasi secara jelas dari Kementerian ESDM serta Kementerian lainnya yang sifatnya bukan hanya sekadar formalitas di lapangan.</p>
                  </div>
                  
                  <div>
                    <h4 className="font-semibold text-gray-800 mb-1">Transportasi Berkelanjutan</h4>
                    <p className="text-gray-700 text-sm">Seperti di Rusia, Indonesia memerlukan integrasi transportasi publik dari satu daerah ke daerah lain sehingga memudahkan mobilitas pengguna.</p>
                  </div>
                  
                  <div>
                    <h4 className="font-semibold text-gray-800 mb-1">Pariwisata, Limbah & Polusi Laut</h4>
                    <p className="text-gray-700 text-sm">Terus menyuarakan usulan dan gagasan anak muda di forum audiensi serta membawa data atau jurnal pendukung sehingga mudah diimplementasikan.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-gray-800 mb-1">Kota Berkelanjutan</h4>
                    <p className="text-gray-700 text-sm">Pentingnya mengutamakan pembangunan yang sesuai dengan karakteristik Indonesia dan bersifat transit oriented. Tidak hanya itu, krusialnya peran masyarakat lokal dalam mengawasi pembangunan IKN agar selalu sustainable.</p>
                  </div>
                  
                  <div>
                    <h4 className="font-semibold text-gray-800 mb-1">Transportasi & Pariwisata</h4>
                    <p className="text-gray-700 text-sm">Memperhatikan kesamaan standar polusi udara antara Kementerian atau institusi di Indonesia dengan institusi global. Masyarakat lokal harus mencontohkan perilaku turisme yang baik.</p>
                  </div>
                  
                  <div>
                    <h4 className="font-semibold text-gray-800 mb-1">Limbah & Polusi Laut</h4>
                    <p className="text-gray-700 text-sm">Perlunya regulasi yang ketat terkait pengolahan limbah bagi setiap industri. Terus mengadvokasi para pebisnis dan elit politik di daerah terkait pentingnya menjaga ekosistem laut.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 bg-gray-50 p-4 rounded-lg">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-700">0856-1601-406</p>
                </div>
              </div>
            </div>
          </div>
